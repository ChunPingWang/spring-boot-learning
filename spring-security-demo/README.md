...
完整的 Spring Security 教學指南，請參閱：

📖 **[SECURITY.md](./SECURITY.md)** - Spring Security 完整教學指南

### 教學大綱

| 章節 | 主題 | 說明 |
|------|------|------|
| 1 | 資訊安全基礎觀念 | CIA 三角、常見威脅、加密概念 |
| 2 | 認證與授權機制 | OAuth2、JWT、OpenID Connect |
| 3 | Spring AOP 概念 | 切面、通知、切入點表達式 |
| 4 | Spring Security 基礎實作 | Security Filter Chain、JWT 認證 |
| 5 | Keycloak 整合實作 | 企業級 IAM 解決方案 |
| 6 | 東西向與南北向安全控管 | API Gateway、Service Mesh、mTLS |
